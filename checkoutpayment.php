  ...
  mb_substr($userProfile["firstName"], 0, 1)
                ...
                <form method="post">
                  <div class="form">
                    ...
                    <label class="radio-field" id="GCASH">
                      <input type="radio" name="payment" id="GCASHRadio" value="GCASH or Credit / Debit Card" class="radio" <?= !empty(
                        $checkout["payment"]
                      ) &&
                      $checkout["payment"] == "GCASH or Credit / Debit Card"
                        ? "checked=checked"
                        : "" ?>/>
                      <p class="ship-label">
                        <span class="iconify payment-icon" data-icon="icons8:GCASH"></span>
                        GCASH or Credit / Debit Card
                      </p>
                      <span class="checkmark"></span>
                    </label>
                    <div id="GCASH-buttons-container"></div>
                  </div>
    ...
    <script src="./assets/js/GCASH.js"></script>
