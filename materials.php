...
?>
  ...
  "supplierEmail"
    ...
    <script>
      ...
      $('#msg').val('Hi, This is Davao Online Shoppe We would like to inform you that ' + materialName + ' is out of stock/low inventory. We would be ordering (quantity) (size). Let us know if or not available. Thank you!' );
